...
$total_revenue = array_sum(array_map(fn($b) => ($b['status'] == 'COM' || $b['status'] == 'COM') ? $b['total_amount'] : 0, $bookings));
                    ...
                    <tr class="booking-row">
                        ...
                        <td>
                            ...
                            <button type="button" onclick="viewBookingDetails(<?= htmlspecialchars(json_encode($booking)) ?>)" 
                                    style="color: white; font-weight: 600; background: #234a23; border: none; cursor: pointer;  padding: 5px;">
                                View
                            </button>
                        </td>
                    </tr>
