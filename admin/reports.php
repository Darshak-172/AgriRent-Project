...
.metric-value.available { color: #234a23; }
.metric-value.pending { color: #234a23; }
.metric-value.rejected { color: #234a23; }
...
function generatePDFReport($conn, $report_type) {
    ...
    echo '<div class="header">
            <h1><img src="../Logo.png" alt="AgriRent Logo" style="height: 50px; width: 50px; background: white; border-radius: 50%; padding: 5px; object-fit: cover; box-shadow: 0 2px 8px rgba(0,0,0,0.15);"><br> AgriRent - ' . ucfirst($report_type) . ' Report</h1>
