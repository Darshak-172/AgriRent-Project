...
<div class="main-content">
    ...
    <div style="margin-top: 20px; padding: 15px; background: #fff3cd; border-radius: 5px;">
        <strong>Note:</strong> Admin can only view bookings.
    </div>
</div>
    ...
    function filterRows() {
        ...
        if (visibleRows === 0 && value !== '') {
            if ($('#noResultsRow').length === 0) {
                $('#bookingsTable tbody').append('<tr id="noResultsRow"><td colspan="8" style="text-align: center; padding: 20px; font-style: italic;">No bookings found </td></tr>');
            }
        } else {
            $('#noResultsRow').remove();
        }
