...
<div class="main-content">
    ...
    <div class="form-section">
        ...
        <form method="POST" id="productForm" enctype="multipart/form-data" novalidate>
            ...
            <!-- Subcategory Selection - CORRECTED -->
            <div class="form-group">
                <label for="subcategory"><strong>2. Select Subcategory *</strong></label>
                <select name="subcategory" id="subcategory" required>
                    <option value="">-- First Select Category --</option>
                    <!-- ✅ CORRECTED: This will be populated dynamically by JavaScript -->
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       maxlength="50" 
                       required>
                <small>(Max 50 characters) - Current: <span id="name-count">0</span></small>
            </div>
            ...
            <div class="form-group">
                ...
                <small>(Max 1000 characters) - Current: <span id="desc-count">0</span></small>
            </div>
            
            <!-- Product Image Upload -->
            <div class="form-group">
                <label for="product_image"><strong>5. Product Image</strong></label>
                <input type="file" 
                       name="product_image" 
                       id="product_image" 
                       accept="image/*"
                       style="padding: 10px; border: 2px dashed #ddd; border-radius: 6px; width: 100%; box-sizing: border-box;">
                <small>Upload a clear image of your product (JPG, PNG, GIF - Max 5MB).</small>
            ...
            <div style="display: flex; gap: 20px; align-items: start;">
                ...
                <div class="form-group" style="flex: 1;">
                    <label for="price"><strong>6. Price per Unit (₹) *</strong></label>
                    <input type="number" 
                           name="price" 
                           id="price" 
                           step="0.01" 
                           ...
                           placeholder="0.00"
                           required>
                    <small>Enter market price</small>
                </div>
                
                <!-- Quantity -->
                <div class="form-group" style="flex: 1;">
                    <label for="quantity"><strong>7. Available Quantity *</strong></label>
                    <input type="number" 
                           name="quantity" 
                           id="quantity" 
                           step="0.01" 
                ...
                <!-- Unit -->
                <div class="form-group" style="flex: 1;">
                    <label for="unit"><strong>8. Unit of Measurement *</strong></label>
            ...
            <!-- Submit Buttons -->
            <div class="form-group">
                <button type="submit" class="btn" id="submit-btn" style="background: #234a23; padding: 15px 30px; font-size: 16px; font-weight: 600;">
...
function loadSubcategories() {
    ...
    console.log('Loaded subcategories:', filteredSubs); // Debug line
}
...
function updatePriceCalculator() {
    ...
    if (price > 0 && quantity > 0 && unit) {
        ...
        // CORRECTED: Changed 'KG' to 'K', 'L' stays same, 'P' stays same
        switch(unit) {
